...
| 006 | Bianchi I cosmology | Planned | — |
| 007 | Dark-fluid emergence | Planned | — |

Use the [experiment record template](templates/experiment-record.md) when work
begins. Add dated run records with revision, configuration, validation evidence,
artifact locations, and conclusions. Distinguish planned, implemented, run,
validated, and inconclusive states; implementation alone is not validation.
